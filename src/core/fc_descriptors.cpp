...
namespace fc
{
  ...
  //
  void FcDescriptors::attachBindlessDescriptors() noexcept
  {
    VkDescriptorSetLayoutBinding layoutBinding {};
  ...
  //
  void FcDescriptors::createDescriptorSetLayout() noexcept
  {
  ...
  VkDescriptorSet FcDescriptors::createDescriptorSet() noexcept
  {
    ...
    if (mLayout != VK_NULL_HANDLE)
    {
      fcPrintEndl("destroying non-null descriptor set before createing a new one");
